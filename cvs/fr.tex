...
\resumeSubHeadingListStart
  \resumeSubheadingWithRef
    ...
    \resumeItemListStart
      \resumeItem{Membre d’une équipe de 60+ élèves assistant qui aident 800+ étudiants de 3e année en programmation.}
      \resumeItem{Assistance au \textbf{débogage et réponses aux questions techniques} dans divers langages.}
      \resumeItem{Conception de travaux pratiques et déploiement de systèmes de correction automatique pour 600+ élèves de 1re année.}
      ...
      \resumeItem{Crash-tests poussés de projets et test suites avec retours constructifs.}
    \resumeItemListEnd
  ...
  \resumeSubheadingWithRef
    ...
    \resumeItemListStart
      ...
      \resumeItem{Développement d’une plateforme full-stack en FastAPI pour la validation et l’annotation de données générées par IA.}
      \resumeItem{Conception d’un système de \textbf{suggstion de causes} basé sur les symptômes rapportés, en étroite collaboration avec les utilisateurs finaux.}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    {Spécialisation : Intelligence Artificielle \& Vision par Ordinateur | GPA : 3.7 | Membre associatif}{2021 -- 2026}

  \resumeSubheading
    {San Francisco State University – Informatique}{San Francisco, États-Unis}
